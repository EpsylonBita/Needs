      ...
      <div className="bg-gradient-to-b from-blue-50 to-white rounded-xl shadow-lg border border-blue-100 p-6">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium text-gray-700">{t('search.category', 'Category')}</Label>
          ...
          {selectedCategory && (
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">{t('search.subcategory', 'Subcategory')}</Label>
          ...
          {/* Smart Tags */}
          <div className="space-y-2">
            <Label className="text-sm font-medium text-gray-700">{t('search.smartTags', 'Smart Tags')}</Label>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <Label className="text-sm font-medium text-gray-700">{t('search.radius', 'Search Radius')}</Label>
